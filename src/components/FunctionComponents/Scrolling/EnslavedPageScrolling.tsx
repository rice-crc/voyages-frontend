...
import EnslavedPage from '../../PastPeople/EnslavedPage';
import EnslavedTable from '../PresentationComponents/Tables/EnslavedTable';
import '@/style/page.scss';
import VoyagesMaps from '@/components/FunctionComponents/PresentationComponents/Map/MAPS';
