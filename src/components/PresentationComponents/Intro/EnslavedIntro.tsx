...
import { getIdStypleEnslaved, getIntroBackgroundEnslavedColor } from '@/utils/functions/getColorStyle';
        ...
        <Box>
          <Grid container className='grid-enslaved-introduction'>
            <Grid className="grid-enslaved-introduction" >
              <div className="intro-box" style={{ backgroundColor: getIntroBackgroundEnslavedColor(styleNamePeople) }}>{textIntroduce}</div>
            </Grid>
          </Grid>
        </Box>
