            ...
            <div className="navbar-subtitle flex-navbar">
                <div className='flex-navbar'>
                    <div className="navbar-subitem">
                        ...
                        <CustomWidthTooltip title={<span className="sr-only-tooltip">{translatedEstimates.queriesTooltip}</span>
                        } placement="bottom" >
                            <i className="fa fa-question-circle tooltip-pointer" data-toggle="tooltip" data-placement="top" title="" aria-hidden="true" ></i>
                        </CustomWidthTooltip>
                    </div>
                    <div className="navbar-subitem">
                        <a data-toggle="collapse" role="button" aria-expanded="false" aria-controls="panelCollapse">
