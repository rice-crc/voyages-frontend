...
const TimeFrame = () => {
    ...
    useEffect(() => {
        ...
        if (storedValue) {
            ...
            if (filterByVarName) {
                const rangeSliderLocal: number[] = filterByVarName.searchTerm as number[];
                ...
                <span className="sidebar-label-form">
                    ...
                    <span>
                        <Input
                            ...
                            name="start"
                            value={currentSliderValue[0] !== undefined ? currentSliderValue[0] : defaultValue[0]}
                            size="small"
                        ...
                        <span className="time-frame-slider">
                            <CustomSliderTimeFrame
                                ...
                                max={1866}
                                size="small"
                                value={currentSliderValue.length > 0 ? currentSliderValue : defaultValue}
