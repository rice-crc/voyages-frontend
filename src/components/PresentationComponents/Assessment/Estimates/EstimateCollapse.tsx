...
const EstimateCollapse: React.FC = () => {
    ...
    const items: CollapseProps['items'] = [
        {
            key: 'time_frame',
            label: <div className='title-coallpse'>{translatedEstimates.timeFrame}</div>,
            children: <div><TimeFrame /></div>
        },
        {
            key: 'flag',
            label: <div className='title-coallpse'>{translatedEstimates.flagData}</div>,
            children: <div><Flag /></div>
        },
        {
            key: 'regions',
            label: <div className='title-coallpse'>{translatedEstimates.regionsData}</div>,
