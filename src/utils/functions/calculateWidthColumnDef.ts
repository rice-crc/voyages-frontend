...
export function calculateWidthColumnDef(
    ...
    if (colID === 'gender' || colID === 'height') {
        ...
        width = 130
    } else if (colID === 'voyage_ship__ship_name' || colID === 'documented_name' || colID === 'modern_name' || colID === 'death' || colID === 'birth') {
        width = 150
        ...
        width = 75
    } else if (colID === 'language_group__name' || colID === 'post_disembark_location__name' || colID === 'voyages__voyage_dates__imp_arrival_at_port_of_dis_sparsedate') {
        width = 175
    }
    return width
}
