...
export const ManifestURLBase = 'https://voyages-api-staging.crc.rice.edu/static/iiif_manifests/'
...
export const performWorkspaceAction = (doc: DocumentItemInfo, element: HTMLElement) => {
...
export const DocumentViewerContext = React.createContext<DocumentViewerContextValue>({ doc: null, setDoc: () => {}})
