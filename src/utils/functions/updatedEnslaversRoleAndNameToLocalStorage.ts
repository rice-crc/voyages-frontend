...
export function updatedEnslaversRoleAndNameToLocalStorage(dispatch: AppDispatch, styleNameRoute: string, listEnslavers: string[], enslaverName: string, varName: string, opsRoles: string, labelVarName: string) {
