...
export const homePageTranslated: TranslateType = {
  ...
  homeDocumentDes: {
    label: {
      ...
      es: `La Compañía del Mar del Sur fue uno de los principales transportadores de personas esclavizadas desde África hacia las Américas durante la primera mitad del siglo XVIII. También transportó cautivos entre puertos dentro del Nuevo Mundo. Como consecuencia, dejó un importante rastro documental que ahora se encuentra en archivos a ambos lados del Atlántico. Vea copias digitales de estos documentos y explore cómo documentan los viajes de esclavos transatlánticos e intraamericanos disponibles en este sitio web.`,
      pt: `A Companhia do Mar do Sul foi uma das principais transportadoras de pessoas escravizadas da África para as Américas durante a primeira metade do século XVIII. Também transportou cativos entre portos dentro do Novo Mundo. Como consequência, deixou um importante rastro documental agora guardado em arquivos dos dois lados do Atlântico. Veja cópias digitais destes documentos e explore como eles documentam as viagens de escravos transatlânticas e intra-americanas disponíveis neste site.`,
    },
  },
  homeEnslavers: {
    label: {
  ...
  homeAfricanDes: {
    label: {
      ...
      es: `Durante los últimos 60 años del comercio transatlántico de esclavos, los tribunales alrededor de las cuencas del Atlántico condenaron más de dos mil embarcaciones por participar en el tráfico y registraron los detalles de los cautivos encontrados a bordo, incluyendo sus nombres africanos. La Base de Datos de Orígenes Africanos fue creada a partir de estos registros, que ahora se encuentran en los Registros de Africanos Liberados en los Archivos Nacionales de Sierra Leona, Freetown, así como en las Series FO84, FO313, CO247 y CO267 conservadas en los Archivos Nacionales Británicos en Londres. Se proporcionan enlaces a los barcos en la Base de Datos Transatlántica de los cuales fueron rescatados los africanos liberados, así como grabaciones de audio que permiten a los usuarios escuchar los nombres y ayudarnos a identificar a qué lenguas pertenecen.`,
      pt: `Durante os últimos 60 anos do comércio transatlântico de escravos, tribunais ao redor das bacias do Atlântico condenaram mais de dois mil navios por participarem do tráfico e registraram os detalhes dos cativos encontrados a bordo, incluindo seus nomes africanos. O Banco de Dados de Origens Africanas foi criado a partir desses registros, agora localizados nos Registros de Africanos Libertados nos Arquivos Nacionais de Serra Leoa, Freetown, bem como nas Séries FO84, FO313, CO247 e CO267 mantidas nos Arquivos Nacionais Britânicos em Londres. São fornecidos links para os navios no Banco de Dados Transatlântico dos quais os africanos libertados foram resgatados, bem como gravações de áudio que permitem aos usuários ouvir os nomes e nos ajudar a identificar a quais línguas eles pertencem.`,
    },
  },
  homeIntra: {
    label: {
  ...
  homeTransDes: {
    label: {
      ...
      es: `Esta base de datos recopila información sobre más de 36.000 viajes que transportaron forzosamente africanos esclavizados a través del Atlántico entre 1514 y 1866. Busque y analice la base de datos para obtener información sobre los amplios orígenes de las personas esclavizadas, el tortuoso Pasaje Medio, y los destinos de los africanos en las Américas.`,
      pt: `Este banco de dados compila informações sobre mais de 36.000 viagens que transportaram forçadamente africanos escravizados através do Atlântico entre 1514 e 1866. Pesquise e analise o banco de dados para obter informações sobre as amplas origens das pessoas escravizadas, a tortuosa Passagem do Meio, e os destinos dos africanos nas Américas.`,
    },
  },
  homeFootSlave: {
    label: {
