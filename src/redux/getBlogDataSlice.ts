...
export const getBlogDataSlice = createSlice({
  ...
  reducers: {
    ...
    setSearchAutoKey: (state, action: PayloadAction<string>) => {
      state.searchAutoKey = action.payload;
    },
    setSearchAutoValue: (state, action: PayloadAction<string>) => {
    ...
    setAuthorPost: (state, action: PayloadAction<Post[]>) => {
