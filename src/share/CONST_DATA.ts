...
export const ALLVOYAGESPAGE = '/voyages/all-voyages'
export const INTRAAMERICAN = 'intra-american'
export const INTRAAMERICANPAGE = '/voyages/intra-american'
export const TRANSATLANTIC = 'trans-atlantic'
export const TRANSATLANTICPATH = 'trans-atlantic'
export const TRANSATLANTICPAGE = '/voyages/trans-atlantic'
export const VOYAGESTEXAS = 'texas'
export const VOYAGESTEXASPAGE = '/voyages/texas'
