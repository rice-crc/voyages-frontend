...
test("setBaseFilterDataSetValue reducer sets the dataSetValueBaseFilter", () => {
    ...
    const state = getDataSetCollectionReducer(initialState, setBaseFilterDataSetValue(baseFilter));
...
test("setBlocksMenuList reducer sets the blocks", () => {
    ...
    const state = getDataSetCollectionReducer(initialState, setBlocksMenuList(blocks));
...
test("setDataSetHeader reducer sets the blocks", () => {
    ...
    const state = getDataSetCollectionReducer(initialState, setDataSetHeader(textHeader));
...
test("setDataSetHeader reducer sets the blocks", () => {
    ...
    const state = getDataSetCollectionReducer(initialState, setTextIntro(textIntroduce));
...
test("setStyleName reducer sets the blocks", () => {
    ...
    const state = getDataSetCollectionReducer(initialState, setStyleName(styleName));
